...
const Template: ComponentStory<typeof Article> = args => (
  <Article {...args}>
    ...
    <p>
      This is what a successive paragraph looks like. Some people prefer a space
      between paragraphs, while others prefer successive paragraphs indented
      with no margins between them.
    </p>
    ...
    <ul>
      ...
      <li>
        ...
        important. Sometimes, an unordered list is a bulleted list. And this is
        a long list item in an unordered list that can wrap onto a new line.{' '}
      </li>
      <li>
